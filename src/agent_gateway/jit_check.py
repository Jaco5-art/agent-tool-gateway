"""Run local Phase 7 acceptance without any API calls."""
import argparse
import asyncio
...
def main():
    ...
    parser.add_argument('--output',default='results/local-phase7-check.json')
