"""Run local Phase 2 acceptance without any API calls."""
import argparse
import io
import json
import unittest
...
def main():
    ...
    parser.add_argument('--output',default='results/local-phase2-check.json')
