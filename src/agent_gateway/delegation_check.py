"""Run local Phase 8 acceptance without any API calls."""
import argparse
import asyncio
...
def main():
    ...
    parser.add_argument('--output',default='results/local-phase8-check.json')
